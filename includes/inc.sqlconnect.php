<?php
	...
	if (!$database)
	{
		die('<html><head><title>Database Error!</title></head><body><h1>Could not connect to Database Server</h1><p>'.mysql_error().'</p></body></html>');
	}
	...
	{
		mysql_close();
		die('<html><head><title>Database Error!</title></head><body><h1>Could not select Database</h1></body></html>');
	}
